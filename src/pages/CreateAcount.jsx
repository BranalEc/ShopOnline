...
function CreateAcount() {
  ...
  // Función que se ejecuta al darle al botón "Crear cuenta"
  const onSubmit = (data) => {
    // Si todo está correcto, muestra la alerta y redirige al Login
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="w-full">
            ...
            <div className="mb-6">
              <input
                ...
                className={`w-full h-[48px] bg-[#f6dce2] rounded-md px-4 outline-none text-gray-700 placeholder:text-gray-500 ${
